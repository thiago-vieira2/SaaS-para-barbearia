...
export function Grafico () {
    return (
        <div className=" flex gap-6 flex-col bg-linear-to-t from-zinc-900 to-zinc-800 transition-all transform  duration-300 hover:shadow-[0_0_12px_4px_rgba(251,191,36,0.6)] w-[45vw] h-[35vh] rounded-xl" >
            <div className='pl-5.5 pt-5'>
